...
By default, your contributions will be anonymous. Signing your contributions with your email address will enable you to be notified when they are integrated or discussed and to be credited publicly for them.

<SignatureEmailInput />

<UpdateButton>Sign your contribution with your email address</UpdateButton>
...
<small>
  If you only want to contribute anonymously, you can <OptOutButton>opt-out now</OptOutButton>. You
  can always join the discussion later, but we will not be able to proactively contact you if we
  have questions.
</small>

# ota-contribution-tool OPS

Recipes to set up the infrastructure for the information-manipulation-analyzer app and deploy it.

> Recettes pour mettre en place l'infrastructure et déployer l'application information-manipulation-analyzer
...
- To setup `ota-contribution-tool` app only:
...
For example, you can update `ota-contribution-tool` by running:
...
log into the vagrant vm and type

See https://forum.yunohost.org/t/update-errors-also-on-fix-commands/14496/68
